...
const Projects = () => {
  const cardsData = [
    ...
    { id: 2, title: 'DomConnect-A Social Media Web App', tech: 'MERN Stack | Reedux | JWT', imgUrl: domconnect ,githubLink:'https://github.com/akashthakur09/DomConnect-Social-Media-Website',liveLink:'https://domconnect-social-media-platform.onrender.com/'},
